...
lstm_model = tf.keras.models.load_model("models/cough-classification-lstm/INPUT_model_path")
cnn_model  = tf.keras.models.load_model("models/cough-classification-cnn/INPUT_model_path")
